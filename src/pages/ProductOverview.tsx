...
const ProductOverview = () => {
  ...
  return (
    <div className="my-5 grid grid-cols-2 justify-end lg:grid-cols-2 sm:grid-cols-1">
      {/* Col 1 */}
      <div className="flex-col p-4 justify-end">
        <h1 className="text-4xl text-gray-800 font-semibold">{product.name}</h1>
        {/* Ratings */}
        ...
        <div className="my-4">
          <h3 className="text-lg text-gray-800 font-semibold">Description</h3>
          <p className="text-gray-500">{product.description}</p>
        </div>

        <div className="my-2">
          <p className="text-lg text-gray-800 font-semibold">Features</p>
          <ul className="text-gray-500 my-1 px-8 list-disc text-center">
      ...
      {/* Col 2 */}
      <div className="flex-col gap-4 justify-self-center items-center">
        {/* Product Image */}
